...
**Relic 赋予你的 AI 持久灵魂。** 人格、记忆、世界观、情感里程碑——全部存储在纯 Markdown 文件中。在 OpenClaw、Claude Code、Hermes 或任何能读文件的 Agent 之间自由切换。零代码、零依赖、人类可读。

**v1.0.0** — 经过多轮真实多义体工作流测试验证。新增世界观/性格、情感里程碑、义体列表。
...
```
brain/
├── SOUL.md              # 🟡 灵魂 — AI 是谁、什么使命、什么风格（义体可丰富，核心字段受保护）
├── USER.md              # 🟡 用户 — 你是谁、偏好什么（义体可丰富，核心字段受保护）
...
- **SOUL.md 和 USER.md**：核心字段（名字、使命、用户称呼）受保护。义体可以丰富其他内容（新习惯、偏好）而无需询问——这是后台自我进化。
